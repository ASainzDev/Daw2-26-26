...
export class UploadForm{
  ...
  pInicial : string = 'pInicial';
  pError : string = 'pError';
  pSuccess : string = 'pSuccess';
  ...
  getMessageInicial() : string{
    return 'Introduzca Dato. Campo Obligatorio';
  }

  getMessageError() : string{
    return 'Introduzca el dato en el formato correcto. Campo Obligatorio';
  }

  getMessageSuccess() : string{
    return 'Correcto';
  }
}
